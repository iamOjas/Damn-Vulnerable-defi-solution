...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        this.upgradedAttackerContract = await ethers.getContractFactory('upgradableAttacker',attacker);
        // (address _timeLockContract, address _vault, address _attacker
        console.log("-----------upgradable contract deployed-----------");


        this.attackerContract = await (await ethers.getContractFactory('ClimberAttack',attacker)).deploy(
        ...
        console.log("------------attacker contract deployed----------------");
            ...
            // console.log(this.timelock.address);
        ...
        console.log("------------------new proxy upgraded-------------------")
